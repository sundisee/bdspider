...
def get_poi_details():
    ...
    cur=conn.cursor()
    cur.execute('select four_cat_url,three_cat_url,three_cat_rank,three_cat_name,four_cat_name,four_cat_rank from baidu_poi where four_cat_url is not null and three_cat_url is not null and addr is null  and total_pingjia is null  order by id')
    result = cur.fetchall()
    print len(result)
